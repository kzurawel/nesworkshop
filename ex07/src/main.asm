...
; let's make some noise
  LDA #%00000111  ; turn on Square 1 + 2, Triangle
  STA $4015
  LDA #%10111000  ; 50% duty cycle, 50% volume
  STA SQ1_ENV
  LDA #%01111000  ; 25% duty cycle, 50% volume
  STA SQ2_ENV

  LDA #$08
  STA SQ1_SWP ; negate sweep to play low notes
  STA SQ2_SWP
...
.word $0356, $0326, $02f9, $02ce, $02a6, $027f, $025c, $023a, $021a, $01fb, $01df, $01c4
.word $01ab, $0193, $017c, $0167, $0151, $013f, $012d, $011c, $010c, $00fd, $00ef, $00e2
