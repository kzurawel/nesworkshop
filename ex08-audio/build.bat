...
c:\cc65\bin\ld65 src\main.o src\sprite.o src\collisions.o src\input.o src\paddle.o src\background.o src\ggsound.o src\tracks.o -C nes.cfg -o ex08-audio.nes
